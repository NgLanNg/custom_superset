...
- `installed_path` = `{project-root}/.claude/phases/phase-4-implementation/00-quick-flow/quick-dev`
- `project_context` = `**/project-context.md` (load if exists)

### Related Workflows

- `quick_spec_workflow` = `{project-root}/.claude/phases/phase-4-implementation/00-quick-flow/quick-spec/workflow.md`
...
Read fully and follow: `{project-root}/.claude/phases/phase-4-implementation/00-quick-flow/quick-dev/steps/step-01-mode-detection.md` to begin the workflow.
