...
- Load `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-07-validation.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-07-validation.md` to validate architectural coherence and completeness.
