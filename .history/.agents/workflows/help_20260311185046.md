...
BMAD rigor requires a proactive entry point. `/start` is the high-fidelity bootstrap that synchronizes context before `/help` routes to the specific technical phase.
