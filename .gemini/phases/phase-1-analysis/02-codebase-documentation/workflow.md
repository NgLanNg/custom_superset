# Workflow: Codebase Documentation
...
Load `config.yaml` from this directory. Execute the state graph starting at `step_01_modules`.
...
- `docs/readme.md` generated with project module map.
- `docs/architecture.md` generated with system architecture patterns.
- Ready to transition to `phase-1-analysis/03-research`.
