...
export default function ScenarioChart(props: ScenarioChartProps) {
  ...
  const [existingData, setExistingData] = useState<ExistingAssetRow[]>(MOCK_EXISTING);
  const [growthData, setGrowthData] = useState<GrowthProjectRow[]>(MOCK_GROWTH);
  ...
  const handleSave = useCallback(
    async (
      ...
      try {
        ...
        notification.error({ message: 'Write-back failed', description: 'Check your connection or try again.' });
      }
            ...
            key: 'growth', label: 'Growth Configuration', children: (
              <SectionCard>
                <EmptyState>
                  ...
                  <div className="es-title">Growth Configuration</div>
                  <div className="es-desc">Configure growth project parameters and forecasting inputs here.</div>
                </EmptyState>
              </SectionCard>
            )
          },
