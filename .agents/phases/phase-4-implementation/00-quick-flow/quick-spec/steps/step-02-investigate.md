...
- IF C: Verify frontmatter updated with `stepsCompleted: [1, 2]`, then read fully and follow: `{project-root}/.claude/phases/phase-4-implementation/00-quick-flow/quick-spec/steps/step-03-generate.md`
