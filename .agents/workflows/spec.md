...
**Purpose: Create a high-fidelity, implementation-ready technical spec through disciplined conversational discovery and deep source investigation.**

**Scope:** `daily`
**Phase:** Phase 2 — Planning
**Deep Mode:** `.agents/phases/phase-2-planning/01-scope/workflow.md`
...
3. **Draft Spec**: Write the implementation roadmap in `docs/specs/`. Include file paths, logic changes, and test requirements.
4. **Scaffold Gate**: Validate against the "Power Spec" standard:
