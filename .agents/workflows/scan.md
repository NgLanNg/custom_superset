...
**Deep Mode:** `.agents/phases/phase-1-analysis/01-project-context/workflow.md`
...
Load: `.agents/phases/phase-1-analysis/01-project-context/steps/step-01-discover.md`
