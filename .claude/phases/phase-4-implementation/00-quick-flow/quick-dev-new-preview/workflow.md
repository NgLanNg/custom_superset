...
- `installed_path` = `{project-root}/.claude/phases/phase-4-implementation/00-quick-flow/quick-dev-new-preview`
- `templateFile` = `{project-root}/.agents/template/tech-spec-quick-dev.template.md`
