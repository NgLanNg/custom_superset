...
- `project_name`, `output_folder`, `planning_artifacts`, `author`
- `communication_language`, `document_output_language`, `user_skill_level`
- `date` as a system-generated value

## QUICK TOPIC DISCOVERY

"Welcome {{author}}! Let's get started with your **technical research**.
...
4. Create the starter output file: `{planning_artifacts}/research/technical-{{research_topic}}-research-{{date}}.md` with exact copy of the `{project-root}/.agents/template/research.template.md` contents
