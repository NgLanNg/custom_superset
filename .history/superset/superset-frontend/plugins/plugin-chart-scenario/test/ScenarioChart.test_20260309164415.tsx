...
describe('ScenarioChart', () => {
    ...
    test('renders tabs correctly', () => {
        ...
        expect(screen.getByText('Existing Assets')).toBeInTheDocument();
        expect(screen.getByText('Growth Projects')).toBeInTheDocument();
    });
    ...
    test('handles cell edit optimistic update and API call', async () => {
        ...
        const inputs = screen.getAllByDisplayValue('70');
