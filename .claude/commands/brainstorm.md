...
> **Also absorbs `/research`** - domain and market research integrated.
...
- When you're stuck or need second opinion on trade-offs
- Before writing a spec or architecture document
- **Domain research for new projects** (absorbs `/research`)
...
4. Output: a short bullet list of design decisions to carry into `/spec`

## Deep Mode
>
> Full collaborative discovery with structured steps.
> **Also include market/domain research when applicable**
...
4. **[Optional: Research]** — For new products, include market analysis, competitors, user personas
...
- **Research integration**: Domain/market research can be included when brainstorming new products
