...
"Welcome back {{author}}! I found your Architecture work for {{project_name}}.
...
- Example: If `stepsCompleted: [1, 2, 3]`, load `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-04-decisions.md`
...
- If confirmed: Delete existing document and read fully and follow: `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-01-init.md`
...
- `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-02-context.md`
- `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-03-starter.md`
- `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-04-decisions.md`
- `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-05-patterns.md`
- `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-06-structure.md`
- `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-07-validation.md`
- `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-08-complete.md`
