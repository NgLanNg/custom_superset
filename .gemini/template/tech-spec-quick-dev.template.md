...
## Verification (Nyquist-First Rule)

<!-- MANDATORY: No implementation code unless BOTH command and expected output are defined below. -->
| Command                       | Expected Output    | Actual Result | Status        |
|-------------------------------|--------------------|---------------|---------------|
| `npm test -- path/to/test.ts` | `PASS: Test Name`  | [Pending]     | [Not Started] |
