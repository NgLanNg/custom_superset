...
**Deep Mode:** `.agents/phases/phase-1-analysis/02-codebase-documentation/workflow.md` (for `--project`)
...
Load: `.agents/phases/phase-1-analysis/02-codebase-documentation/workflow.md`
