...
Load `config.yaml` from this directory. Execute the state graph starting at `read_context`.
...
- `docs/scope.md` generated with project goal, in/out-of-scope items, and success criteria.
- Ready to transition to `phase-2-planning/02-task-breakdown`.
