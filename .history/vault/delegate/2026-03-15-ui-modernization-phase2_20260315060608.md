...
| ID | Criteria | Status |
|----|----------|--------|
| AC-UI-02 | Filter tags display with dismiss X | [x] |
| AC-UI-03 | Clear all resets all filters | [x] |
| AC-Filter-01 | Panel padding matches mockup (12px) | [x] |
| AC-Filter-02 | All filters support multi-select | [x] |
| AC-Filter-03 | Section labels visible | [x] |
