...
Copy this skill folder to your project's `.agents/skills/` directory:

```bash
cp -r sequential-thinking /path/to/your/project/.agents/skills/
```
...
- [Agent Skills Documentation](https://docs.agents.com/en/docs/agents-and-tools/agent-skills/overview.md)
