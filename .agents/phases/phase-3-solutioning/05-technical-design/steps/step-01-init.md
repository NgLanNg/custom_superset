...
- **STOP here** and load `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-01b-continue.md` immediately
...
Copy the template from `{project-root}/.agents/template/architecture-decision.template.md` to `{planning_artifacts}/architecture.md`
...
"Welcome {{author}}! I've set up your Architecture workspace for {{project_name}}.
...
After user selects [C] to continue, only after ensuring all the template output has been created, then load `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-02-context.md` to analyze the project context and begin architectural decision making.
