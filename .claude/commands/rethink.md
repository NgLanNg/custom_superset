...
**Deep Mode:** `.claude/phases/phase-4-implementation/09-course-correction/workflow.md`
...
3. Update `vault/tasks/todo_{brief}_{date}.md` to reflect the new plan
...
Load: `.claude/phases/phase-4-implementation/09-course-correction/workflow.md`
...
4. **Resume** — Once approved, update `vault/tasks/todo_{brief}_{date}.md` and continue

## Output

- `docs/change_proposal.md`
- Updated `vault/tasks/todo_{brief}_{date}.md`
