...
When ALL tasks are complete (or halted on blocker), read fully and follow: `{project-root}/.claude/phases/phase-4-implementation/00-quick-flow/quick-dev/steps/step-04-self-check.md`.
