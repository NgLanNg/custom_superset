...
"Welcome {{author}}! Let's get started with your **market research**.
...
4. Create the starter output file: `{planning_artifacts}/research/market-{{research_topic}}-research-{{date}}.md` with exact copy of the `{project-root}/.agents/template/research.template.md` contents
