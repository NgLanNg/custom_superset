...
SQLALCHEMY_DATABASE_URI = os.environ.get("SUPERSET_DATABASE_URI", _PG_URI)
SQLALCHEMY_EXAMPLES_URI = _PG_URI
...
def FLASK_APP_MUTATOR(app):  # noqa: N802
    ...
    try:
        ...
        # add_view_no_menu registers the route but hides it from the navbar
        appbuilder.add_view_no_menu(ScenarioWritebackView)
        appbuilder.add_view_no_menu(GrowthConfigView)
    except ImportError:
        pass  # View not found/optional
