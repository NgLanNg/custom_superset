...
With findings in hand, read fully and follow: `{project-root}/.claude/phases/phase-4-implementation/00-quick-flow/quick-dev/steps/step-06-resolve-findings.md` for user to choose resolution approach.
