...
- Load: `{project-root}/.claude/phases/phase-1-analysis/research/market-steps/step-05-competitive-analysis.md`
...
After user selects 'C', load `{project-root}/.claude/phases/phase-1-analysis/research/market-steps/step-05-competitive-analysis.md` to analyze competitive landscape, market positioning, and competitive strategies for {{research_topic}}.
