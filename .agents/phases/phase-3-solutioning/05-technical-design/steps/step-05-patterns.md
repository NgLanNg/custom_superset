...
- Load `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-06-structure.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.claude/phases/phase-3-solutioning/05-technical-design/steps/step-06-structure.md` to define the complete project structure.
