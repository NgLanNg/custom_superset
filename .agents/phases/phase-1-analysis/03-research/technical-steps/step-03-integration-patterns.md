...
- Load: `{project-root}/.claude/phases/phase-1-analysis/research/technical-steps/step-04-architectural-patterns.md`
...
After user selects 'C', load `{project-root}/.claude/phases/phase-1-analysis/research/technical-steps/step-04-architectural-patterns.md` to analyze architectural patterns, design decisions, and system structures for {{research_topic}}.
